...
local base = import 'pgrapher/experiment/pcbro-50liter/params.jsonnet';
      ...
      volumes: [
          {
              ...
              name: "pcbro",
              faces: [
                  {anode: 0, response: 20*wc.cm, cathode: 38*wc.cm},
                  null],
          }
      ],
      bounds : {
          tail: wc.point(100.0, -100.0, -100.0, wc.mm),
          head: wc.point(301.0, +100.0, +100.0, wc.mm),
      },
  },
