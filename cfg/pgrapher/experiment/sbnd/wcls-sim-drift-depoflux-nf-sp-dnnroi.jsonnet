...
local wcls_output_sim = {
 ...
 // The noise filtered "ADC" values.  These are truncated for
  ...
  sp_signals: wcls.output.signals(name="spsignals", tags=["gauss", "wiener", "dnnsp"]),
...
local dnnroi = import '/exp/sbnd/app/users/munjung/wirecell/sbndcode/wire-cell-toolkit/cfg/pgrapher/experiment/sbnd/dnnroi.jsonnet';
local ts = {
    type: "TorchService",
    name: "dnnroi",
    data: {
        model: "/exp/sbnd/app/users/munjung/wirecell/sbndcode/ts-models/uresnet-tpc0-bothplanes_2000samples_rebin4_adam.ts",
        device: "cpu",
        concurrency: 1,
    },
};
...
local multipass2 = [
  g.pipeline([
              ...
              //  nf_pipes[n], // NEED to include this pipe for channelmaskmaps    
               ...
               dnnroi(tools.anodes[n], ts, output_scale=1),
               //hio_dnnroi[n],
