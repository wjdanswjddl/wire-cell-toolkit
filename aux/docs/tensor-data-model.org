...
t.b.d.  A tree node uses MD to encode datapath to *parent* node, an array of datapaths to encode ownership of the *children* and a set of *named datasets* to encode the payload PCs.
