...
the node types of an ~ICluster~ graph (/wire/, /channel/, /measure/, /blob/ and
/slice/) and edges between them.  It generally follows an array schema
outlined in the document [[file::ClusterArrays.org][on Cluster Arrays]].  Their representation
is similar to [[https://pytorch-geometric.readthedocs.io/en/latest/generated/torch_geometric.data.HeteroData.html#torch_geometric.data.HeteroData][~HeteroData~]] type from pytorch-geometric.
