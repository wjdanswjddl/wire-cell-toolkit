...
2. [@2] /value/, the central value of the signal
...
0. [@0] /edesc,/ (int), the edge descriptor counts the edge in the graph
...
- [ ] extend ~ClusterArrays~ to provide round-trip with ~ICluster~.
