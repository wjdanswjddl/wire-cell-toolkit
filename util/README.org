...
#+include: docs/point-cloud.org :minlevel 1
#+include: docs/rectangles.org :minlevel 1
...
- [[file:docs/rectangles.org]] :: a 2-D interval tree.  Similar to a sparse array of pixels but requiring no grid.
